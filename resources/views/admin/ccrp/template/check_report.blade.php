...
<div>
    ...
    <h4 align=center>{{$result->task->company->title}}冷链资源管理系统<u>第{{$result->task->template->cycle_type==1?\Carbon\Carbon::createFromTimestamp($result->task->start)->month:\Carbon\Carbon::createFromTimestamp($result->task->start)->quarter}}{{\App\Models\Ccrp\CheckTemplate::CYCLE_TYPE[$result->task->template->cycle_type]}}</u>巡检报告</h4>
