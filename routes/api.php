...
$api->version('v1', [
    ...
    $api->group([
        ...
        //冰箱品牌
        $api->get('cooler_brands/{pagesize?}','CoolerBrandsController@index')->name('api.ccrp.cooler_brands.store');
        ...
        //冰箱型号
        $api->post('cooler_models/index/{pagesize?}','CoolerModelsController@index')->name('api.ccrp.cooler_models.index');
